...
import com.kreamify.domain.product.dto.ProductTestRequest;
...
class AdminControllerTest {
    ...
    private static final LocalDate RELEASE_DATE = LocalDate.parse("21/01/04", DateTimeFormatter.ofPattern("yy/MM/dd"));
